...
public class DriverServiceTests {
    ...
    {
        try {
            driverService.registerNewDriver(new DriverDto("Padma","p@gmail.com","Pass",9876545675L,3452,7896,"Ola",1));
        } catch (nullFieldException e) {
...
////        }
//        Driver d1= new Driver("Padma","padma@gmail.com","padma@12",9876543211L,890,78,"Ola",1,null);
//        Driver d2= new Driver("Jayashree","jaya@gmail.com","jaya@12",9876543210L,899,98,"Uber",2,null);
...
//    }
    ...
    {
        try {
            driverService.updateDriver(null,new Driver(2,
                    "Padma",
                    "padma@gmail.com",
                    "padma@12",
                    9876543210L,
...
/*
    ...
    public void checkPhNumberTestExceptionMessageInChangeMobileNumber() throws nullFieldException, noChangeException {
        ...
        try {
            DriverDto driverDto = new DriverDto("Padma","p@gmail.com","Pass",9876545675L,3452,7896,"Ola",1);
            ...
            Long newMobileNumber = 9876545675L;
